...
public class GameScreen6 extends Screen {
	...
	/**
	 * Constructs a GameScreen6 object with the specified DrawingSurface.
	 *
	 * @param surface The DrawingSurface on which this screen will be displayed.
	 */
	public GameScreen6(DrawingSurface surface) {
		super(800, 600);
	...
	public void draw() {
		...
		surface.fill(0);
		String str = "What is an emergency fund?";
		...
		surface.rect(button1.x, button1.y, button1.width, button1.height, 10, 10, 10, 10);
		surface.fill(0);
		String str1 = "A savings account for future large purchases";
		...
		surface.fill(0);
		String str2 = "A fund to cover unexpected expenses";
		...
		surface.fill(0);
		String str3 = "Money saved for retirement";
		...
		surface.fill(0);
		String str4 = "Money saved for buying a car";
		...
		surface.fill(0);
		surface.textSize(20);
		String str5 = "What is an emergency fund?";

...
/**
 * Represents the fourth screen of the application.
...
public class GameScreen4 extends Screen {
	...
	/**
	 * Constructs a GameScreen4 object with the specified DrawingSurface.
	 *
	 * @param surface The DrawingSurface on which this screen will be displayed.
	 */
	public GameScreen4(DrawingSurface surface) {
		super(800, 600);
	...
	public void draw() {
		...
		surface.fill(0);
		String str = "A) Saving a fixed percentage of your income regularly";
		...
		surface.fill(0);
		String str2 = "B) Spending all your income on immediate needs";
		...
		surface.fill(0);
		String str3 = "C) Investing all your money in high-risk ventures";
		...
		surface.fill(0);
		String str5 = "D) Ignoring the need for a savings plan";
		...
		surface.fill(0);
		String str6 = "What is a recommended approach to budgeting and saving?";
	...
	public void mousePressed() {
		...
		if (button6.contains(p)) {
			surface.switchScreen(ScreenSwitcher.GAME_SCREEN5);
			return;

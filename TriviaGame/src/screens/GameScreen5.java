...
public class GameScreen5 extends Screen {
	...
	/**
	 * Constructs a GameScreen5 object with the specified DrawingSurface.
	 *
	 * @param surface The DrawingSurface on which this screen will be displayed.
	 */
	public GameScreen5(DrawingSurface surface) {
		super(800, 600);
	...
	public void draw() {
		...
		surface.fill(0);
		String str = "A) Setting financial goals and tracking expenses";
		...
		surface.fill(0);
		String str2 = "B) Relying solely on credit cards for purchases";
		...
		surface.fill(0);
		String str3 = "C) Using a financial advisor to manage your funds";
		...
		surface.fill(0);
		String str5 = "D) Avoiding making any financial plans";
		...
		surface.fill(0);
		String str6 = "What is an effective way to manage personal finances?";
	...
	public void mousePressed() {
		...
		if (button6.contains(p)) {
			surface.switchScreen(ScreenSwitcher.GAME_SCREEN6);
			return;

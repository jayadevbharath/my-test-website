...
public class GameScreen9 extends Screen {
	...
	/**
	 * Constructs a GameScreen9 object with the specified DrawingSurface.
	 *
	 * @param surface The DrawingSurface on which this screen will be displayed.
	 */
	public GameScreen9(DrawingSurface surface) {
		super(800, 600);
	...
	public void draw() {
		...
		surface.fill(0);
		String str = "Which of the following best describes an installment loan?";
		...
		surface.rect(button1.x, button1.y, button1.width, button1.height, 10, 10, 10, 10);
		surface.fill(0);
		String str1 = "A loan repaid in regular payments over time";
		...
		surface.fill(0);
		String str2 = "A loan that requires payment in full at once";
		...
		surface.fill(0);
		String str3 = "A type of credit card debt";
		...
		surface.fill(0);
		String str4 = "A loan with fluctuating interest rates";
		...
		surface.fill(0);
		surface.textSize(20);
		String str5 = "\"Which of the following best describes an installment loan?\""; // Update this if needed

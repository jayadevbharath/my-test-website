...
public class GameScreen1 extends Screen {
	 ...
	 */
	public GameScreen1(DrawingSurface surface) {
		super(800, 600);
	...
	public void draw() {
		...
		surface.fill(0);
		String str2 = "B) Compounding returns over time";
		...
		surface.fill(0);
		String str3 = "C) Avoiding the stock market";
		...
		surface.fill(0);
		String str5 = "D) Higher interest rates";
		...
		surface.fill(0);
		String str6 = "What is the main advantage of starting to invest early in life?";
...
//			surface.switchScreen(ScreenSwitcher.GAME_SCREEN2);
//			return;
//		}

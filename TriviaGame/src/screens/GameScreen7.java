...
public class GameScreen7 extends Screen {
	...
	/**
	 * Constructs a GameScreen7 object with the specified DrawingSurface.
	 *
	 * @param surface The DrawingSurface on which this screen will be displayed.
	 */
	public GameScreen7(DrawingSurface surface) {
		super(800, 600);
	...
	public void draw() {
		...
		surface.fill(0);
		String str = "What is a credit score?";
		...
		surface.rect(button1.x, button1.y, button1.width, button1.height, 10, 10, 10, 10);
		surface.fill(0);
		String str1 = "A measure of how much debt you have";
		...
		surface.fill(0);
		String str2 = "A number representing your creditworthiness";
		...
		surface.fill(0);
		String str3 = "A calculation of your net income";
		...
		surface.fill(0);
		String str4 = "A summary of your banking transactions";
		...
		surface.fill(0);
		surface.textSize(20);
		String str5 = "What is a credit score?";
	...
	public void mousePressed() {
		...
		if (button6.contains(p)) {
			surface.switchScreen(ScreenSwitcher.GAME_SCREEN8);
			return;

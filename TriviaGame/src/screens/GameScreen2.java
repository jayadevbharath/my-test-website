...
public class GameScreen2 extends Screen {
	 ...
	 */
	public GameScreen2(DrawingSurface surface) {
		super(800, 600);
	...
	public void draw() {
		...
		surface.fill(0);
		String str6 = "Which of the following is considered a low-risk investment?";
	...
	public void mousePressed() {
		...
		if (button6.contains(p)) {
			surface.switchScreen(ScreenSwitcher.GAME_SCREEN3);
			return;
